 ...
 * simulated parent ("Ms Turner") replies after a realistic
...
function generateParentReply(text) {
  ...
  if (/(late|absen|sick|miss)/.test(t))
    return "Thanks for letting me know - Grace had a dentist appointment this morning. She'll be in for period 3.";
  ...
  if (/\?/.test(t))
    return "Good question - let me check with Grace tonight and get back to you.";

  // Generic positive fallbacks
  const fallbacks = [
    "Thanks for the update, Mr Chen!",
    "Appreciate you reaching out - I'll have a chat with Grace after school.",
...
const INITIAL_THREADS = [
  {
    id: 'demo-t1',
    title: 'Ms Turner · Year 11',
    participants: [
      { role: 'teacher', name: ME },
      { role: 'parent',  name: 'Ms J. Turner' },
    ],
    unread: 0,
    messages: [
      { id: 'd1', from: 'parent',  text: "Hi Mr Chen - just letting you know Grace was a bit unwell yesterday. Hope she's okay in class today!",        time: '8:14 am' },
